...
class DiscordRPC(
    ...
    companion object {
        ...
        private const val APP_ICON_URL = 
            "https://raw.githubusercontent.com/Dieghosty10/ghostymusicy/refs/heads/master/assets/icon.png"
    ...
    suspend fun updateSong(
        ...
        val button2Label = context.dataStore[DiscordActivityButton2LabelKey] ?: "Go to ghostymusicy"
        ...
        val button2CustomUrl = context.dataStore[DiscordActivityButton2CustomUrlKey] ?: "https://github.com/Dieghosty10/ghostymusicy"
    ...
    suspend fun refreshActivity(song: Song, currentPlaybackTimeMillis: Long, isPaused: Boolean = false) = runCatching {
        try {
            ...
            com.dieghosty10.ghostymusicy.utils.GlobalLog.append(
