...
import com.dieghosty10.ghostymusicy.App
import com.dieghosty10.ghostymusicy.constants.GitHubReleasesEtagKey
import com.dieghosty10.ghostymusicy.constants.GitHubReleasesFingerprintKey
import com.dieghosty10.ghostymusicy.constants.GitHubReleasesJsonKey
import com.dieghosty10.ghostymusicy.constants.GitHubReleasesLastCheckedAtKey
...
object Updater {
    ...
    private suspend fun fetchReleasesNetwork(
        ...
        val response: HttpResponse =
            client.get("https://api.github.com/repos/Dieghosty10/ghostymusicy/releases?per_page=$perPage") {
                headers {
                    append("Accept", "application/vnd.github+json")
                    append("User-Agent", "ghostymusicy")
    ...
    private suspend fun resolveApkDownloadUrl(tagName: String): String {
        val fallback =
            "https://github.com/Dieghosty10/ghostymusicy/releases/download/$tagName/$APK_ASSET_NAME"

        return runCatching {
            val response = client.get(
                "https://api.github.com/repos/Dieghosty10/ghostymusicy/releases/tags/$tagName"
            ) {
                headers {
                    append("Accept", "application/vnd.github+json")
                    append("User-Agent", "ghostymusicy")
    ...
    suspend fun getCommitHistory(count: Int = 20, branch: String = "master"): Result<List<GitCommit>> =
        runCatching {
            val response =
                client.get("https://api.github.com/repos/Dieghosty10/ghostymusicy/commits?sha=$branch&per_page=$count") {
                    headers {
                        append("Accept", "application/vnd.github+json")
                        append("User-Agent", "ghostymusicy")
                    }
    ...
    fun getLatestDownloadUrl(): String {
        ...
        return when (channel) {
            UpdateChannel.STABLE -> {
                "https://github.com/Dieghosty10/ghostymusicy/releases/latest/download/$APK_ASSET_NAME"
            }
            UpdateChannel.NIGHTLY -> {
