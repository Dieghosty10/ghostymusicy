...
sealed interface TogetherClientEvent {
    ...
    data class JoinDecision(
        val decision: com.dieghosty10.ghostymusicy.together.JoinDecision,
    ) : TogetherClientEvent
    ...
    data class HeartbeatPong(
        val pong: com.dieghosty10.ghostymusicy.together.HeartbeatPong,
                ...
                try {
                    while (true) {
                        ...
                        when (message) {
                            ...
                            is com.dieghosty10.ghostymusicy.together.JoinDecision -> {
