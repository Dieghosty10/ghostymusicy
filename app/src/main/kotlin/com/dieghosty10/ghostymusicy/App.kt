...
import com.dieghosty10.ghostymusicy.constants.*
import com.dieghosty10.ghostymusicy.extensions.*
// Removed broken UI imports
// import com.dieghosty10.ghostymusicy.ui.screens.settings.ThemePalettes
// import com.dieghosty10.ghostymusicy.ui.theme.ThemeSeedPalette
// import com.dieghosty10.ghostymusicy.ui.theme.ThemeSeedPaletteCodec
...
// import com.dieghosty10.ghostymusicy.ui.player.CanvasArtworkPlaybackCache
...
class App : Application(), SingletonImageLoader.Factory {
    ...
    override fun onCreate() {
        ...
        Timber.plant(Timber.DebugTree())
        try {
            Timber.plant(com.dieghosty10.ghostymusicy.utils.GlobalLogTree())
        } catch (_: Exception) {}
    ...
    private fun initializeCriticalSync() {
        // CanvasArtworkPlaybackCache.init(this) // Removed due to UI rebuild
    ...
    private fun initializeDeferredAsync() {
        applicationScope.launch(Dispatchers.IO) {
            try {
                ...
                // Removed ThemePalettes usage for now, will re-implement with new UI
                /*
