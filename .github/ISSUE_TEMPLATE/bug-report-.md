---
name: Bug Report
about: Report a bug found in ghostymusicy to help us improve the application
title: "[BUG] Brief description of the issue"
labels: bug
assignees: Dieghosty10
---
...
## System Information
- **ghostymusicy Version:** <!-- e.g., 1.2.3 -->
...
```
**How to capture logs:**
- Use `adb logcat | grep -i ghostymusicy` for filtered logs
...
- [ ] I have tested on the latest version of ghostymusicy
